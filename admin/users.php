				...
				<div class="col-12">
					<div class="main__table-wrap">
						<table class="main__table">
							...
							<tbody>
								<?php
									$user_query = "SELECT * FROM `users` ORDER BY level";
								...
								<tr>
									...
									<td>
										<div class="main__table-text secondary_color text-bold"><?= $row["oap_name"]; ?></div>
									</td>
									<td>
										<div class="main__table-text"><?= $row["username"]; ?></div>
									</td>
									<td>
										<div class="main__table-text"><?= $row["position"]; ?></div>
									</td>
									<td>
										<div class="main__table-text"><?= $row["no_of_shows"]; ?></div>
									</td>
									<td>
									...
									<td>
										<div class="main__table-btns">
											...
											<a href="edit-user.php?user_id=<?= $row["id"]; ?>" class="main__table-btn main__table-btn--edit">
